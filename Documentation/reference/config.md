...
Environment variables respected by the Go standard library can be specified if
needed. Some notable examples:
...
If `direct` is `false`, this URL is provided in the notification callback sent to the broker.
